...
class ArticleReadTimeEngine:
    ...
    def estimate_reading_time(article, words_per_minute=250, seconds_per_image=10, seconds_per_tag=2):
        ...
        word_count_article_description = ArticleReadTimeEngine.word_count(article.description)

        total_word_count = word_count_body + word_count_title + word_count_article_description
